...
class CalculatorTest {
    ...
    void testCalculateDiscount() {
        ...
        Assertions.assertThat(calculator.calculateDiscount(purchaseAmount, discountPercentage))
                .isEqualTo(expectedDiscountedAmount);

        // Test when purchaseAmount is negative
        Assertions.assertThatThrownBy(() -> calculator.calculateDiscount(-10.0, discountPercentage))
                .isInstanceOf(ArithmeticException.class);

        // Test when discountPercentage is negative
        Assertions.assertThatThrownBy(() -> calculator.calculateDiscount(purchaseAmount, -10.0))
                .isInstanceOf(ArithmeticException.class);

        // Test when discountPercentage is greater than 100
        Assertions.assertThatThrownBy(() -> calculator.calculateDiscount(purchaseAmount, 110.0))
                .isInstanceOf(ArithmeticException.class);
    }
}